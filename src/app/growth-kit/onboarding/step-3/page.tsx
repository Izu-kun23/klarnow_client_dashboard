...
import GrowthKitStep3Form from '@/components/growth-kit/onboarding/Step3Form'
import { checkOnboardingComplete } from '@/utils/onboarding-check'

export default function GrowthKitStep3Page() {
      ...
      <div className="min-h-screen bg-white py-8 transition-all duration-300">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-xl bg-white p-8 shadow-sm border border-red-200">
            ...
            <button
              onClick={() => router.push('/growth-kit/onboarding/step-2')}
  ...
  return (
    <GrowthKitStep3Form project={null} step={step} />
  )
}
